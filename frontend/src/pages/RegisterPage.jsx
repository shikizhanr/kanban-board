            ...
            <div className="w-full max-w-md">
                <form onSubmit={handleSubmit} className="bg-white dark:bg-neutral-800 p-8 rounded-xl shadow-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label className="block text-gray-700 dark:text-neutral-300 mb-2" htmlFor="firstName">Имя</label>
                            <input type="text" id="firstName" value={firstName} onChange={e => setFirstName(e.target.value)} required className="w-full px-4 py-2 border dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-neutral-700 text-gray-900 dark:text-white" />
                        </div>
                        <div>
                            <label className="block text-gray-700 dark:text-neutral-300 mb-2" htmlFor="lastName">Фамилия</label>
                            <input type="text" id="lastName" value={lastName} onChange={e => setLastName(e.target.value)} required className="w-full px-4 py-2 border dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-neutral-700 text-gray-900 dark:text-white" />
                        </div>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-6">
                        <label className="block text-gray-700 dark:text-neutral-300 mb-2" htmlFor="password">Пароль (мин. 8 символов)</label>
                    ...
                    <p className="text-center text-sm text-gray-500 dark:text-neutral-400 mt-6">
                        Уже есть аккаунт? <Link to="/login" className="text-indigo-600 dark:text-indigo-400 hover:underline">Войти</Link>
                    </p>
                </form>
            </div>
        </div>
